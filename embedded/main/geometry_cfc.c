/*
 * geometry_cfc.c — Ternary CfC: Closed-form Continuous-time Liquid Network
 *                  on the Geometry Intersection Engine
 *
 * Milestone 7: The first fully-ternary CfC.
 *
...
void app_main(void) {
    ...
    printf("\n");
    printf("============================================================\n");
    printf("  TERNARY CfC — Closed-form Continuous-time Liquid Network\n");
    printf("  Milestone 7: Fully Ternary {-1, 0, +1}\n");
